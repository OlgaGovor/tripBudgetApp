...
export const ExpenseRepository = {
    ...
    useByTripAndDate(tripId: string, date: string) {
        return useLiveQuery(() => db.expenses.where('tripId').equals(tripId).filter(expense => expense.date === date).toArray(), [tripId, date])
    },
}
